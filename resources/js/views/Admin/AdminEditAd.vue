<template>
    <div class="container mt-4 add-container">
        <div class="col-md-6 col-10 mx-auto">
            ...
            <form class="mb-5" @submit.prevent="editAd" novalidate>
...
export default {
    ...
    async created() {
        try {
            const res = await axios.get(
                "/api/admin/ads/" + this.$route.params.ad_id
            );
            this.formReg.productId = res.data.product.id;
            this.formReg.image = res.data.img;
        } catch (e) {
            console.error(e);
        }
    },
    ...
    methods: {
        ...
        editAd() {
            axios.put("/api/admin/ads/" + this.$route.params.ad_id, {
