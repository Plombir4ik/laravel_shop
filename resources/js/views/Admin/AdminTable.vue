    ...
    <div class="container" style="min-height: 100vh">
        ...
        <div class="row">
            <div class="col-12 mx-auto">
                ...
                <router-link
                    :to="'/admin/specs/' + this.$route.params.cat"
                    class="ml-2 add-button"
                >
                    Характеристики
                </router-link>
                <button
                    @click="deleteSubcategory($route.params.cat)"
                    class="ml-2 add-button"
                    style="background: #dc3545; padding: 2.5px 20px"
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="18"
        ...
        <table class="table table-striped text-left">
            ...
            <tr v-for="product in filterList" :key="product.id">
                ...
                <td>
                    <router-link :to="'/admin/edit/' + product.id" class="btn btn-info">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="16"
                            height="16"
...
export default {
    ...
    methods: {
        ...
        deleteSubcategory(subcat_id) {
            axios.delete("/api/admin/categories/subcategories/" + subcat_id)
                .then(() => this.$router.push({ name: "Admincategory" }));
        },
